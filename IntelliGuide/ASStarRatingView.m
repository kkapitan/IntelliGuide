...
- (void)baseInit {
    _notSelectedStar = [UIImage imageNamed:@"star-template"];
    _selectedStar = [UIImage imageNamed:@"star-highlighted-template"];
    _halfSelectedStar = [UIImage imageNamed:@"star-highlighted-template"];
